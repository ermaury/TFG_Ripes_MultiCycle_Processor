...
constexpr int32_t zero_div_overflow32 = (-2147483648); //-2^(32-1)
constexpr int64_t zero_div_overflow64 = (LLONG_MIN);   //-2^(64-1)

template <unsigned XLEN>
class ALUZero : public Component {
public:
  SetGraphicsType(ALU);
  ALUZero(const std::string &name, SimComponent *parent) : Component(name, parent) {
